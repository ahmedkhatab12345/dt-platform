           ...
           {{-- الجهة الحكومية --}}
            ...
            <div>
                ...
                <select name="start_month"
                    ...
                    <option value="{{ $month }}"
                        {{ old('start_month', optional($project->start_date)->month) == $month ? 'selected' : '' }}>
                        {{ $month }}
                    </option>
                    @endfor
                </select>
                ...
                <select name="start_year"
                    ...
                    <option value="{{ $year }}"
                        {{ old('start_year', optional($project->start_date)->year) == $year ? 'selected' : '' }}>
                        {{ $year }}
                    </option>
                    @endfor
                </select>
            ...
            <div>
                ...
                <select name="end_month"
                    ...
                    @for ($month = 1; $month <= 12; $month++)
                    <option value="{{ $month }}"
                        {{ old('end_month', optional($project->end_date)->month) == $month ? 'selected' : '' }}>
                        {{ $month }}
                    </option>
                    @endfor
                </select>
                ...
                <select name="end_year"
                    ...
                    @for ($year = 2020; $year <= 2030; $year++)
                    <option value="{{ $year }}"
                        {{ old('end_year', optional($project->end_date)->year) == $year ? 'selected' : '' }}>
                        {{ $year }}
                    </option>
                    @endfor
                </select>
