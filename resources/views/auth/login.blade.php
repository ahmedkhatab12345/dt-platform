...
<body class="min-h-screen relative flex items-center justify-center bg-slate-50">
    <div class="absolute inset-0 -z-10 overflow-hidden">
        <div class="absolute -top-24 -left-16 h-80 w-80 rounded-full bg-gradient-to-tr from-indigo-400 to-violet-400 blur-3xl opacity-30"></div>
        <div class="absolute -bottom-24 -right-16 h-96 w-96 rounded-full bg-gradient-to-tr from-cyan-400 to-blue-400 blur-3xl opacity-30"></div>
    </div>

    <div class="w-full max-w-[420px] rounded-3xl bg-white/80 backdrop-blur-md border border-white/50 shadow-2xl p-8">
        <div class="text-center">
            <h1 class="text-2xl font-semibold tracking-tight text-slate-900">Sign in</h1>
            <p class="mt-1 text-sm text-slate-500">Enter your credentials to access your account</p>
        </div>
            ...
            <div>
                ...
                <div class="relative">
                    <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username"
                           ...
                           class="w-full pr-4 pl-10 py-2 rounded-xl border border-slate-300 bg-white/70 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div>
                ...
                <div class="relative">
                    <input id="password" type="password" name="password" required autocomplete="current-password"
                           placeholder="••••••••"
                           class="w-full pr-20 pl-10 py-2 rounded-xl border border-slate-300 bg-white/70 shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                    <svg class="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-slate-400" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                    ...
                    <button type="button" id="togglePassword"
                            class="absolute right-2 top-1/2 -translate-y-1/2 text-sm px-3 py-1 rounded-md text-slate-600 hover:text-slate-800">
                        Show
                    </button>
                </div>
                @error('password')
