...
<div class="bg-white rounded-xl shadow p-6 max-w-4xl mx-auto">
  <h2 class="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
    ...
    تعديل الشراكة/الاتفاقية: {{ \Illuminate\Support\Str::limit($partnership->agreement_title, 60, '...') }}
  </h2>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div>
        ...
        <textarea name="agreement_title" rows="1"
                  ...
                  placeholder="أدخل عنوان الاتفاقية">{{ old('agreement_title', $partnership->agreement_title) }}</textarea>
