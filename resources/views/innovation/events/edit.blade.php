...
<div class="bg-white rounded-xl shadow p-6 max-w-4xl mx-auto">
  <h2 class="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
    ...
    تعديل الفعالية/المبادرة: {{ \Illuminate\Support\Str::limit($event->event_title, 60, '...') }}
  </h2>
  ...
  <form method="POST" action="{{ route('innovation.events.update', $event) }}" class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div>
        ...
        <textarea name="event_title" rows="1"
                  ...
                  placeholder="أدخل عنوان الفعالية أو المبادرة">{{ old('event_title', $event->event_title) }}</textarea>
